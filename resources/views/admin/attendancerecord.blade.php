    ...
    <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
            ...
            <div
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-center sm:text-left w-full sm:w-auto">Monthly Attendance
                    Summary ({{ $currentMonthYear }})</h3>
                <a href="{{ route('attendance-record.index') }}"
                    class="text-xs sm:text-sm font-medium hover:text-white/90 transition-colors underline w-full sm:w-auto text-center sm:text-right">Refresh
                    Data</a>
            </div>
                                    ...
                                    @foreach($employeeSummaries as $employeeSummary)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="px-3 sm:px-6 py-4 font-medium text-gray-900">
                                                {{ $employeeSummary['employee_name'] ?? 'N/A' }}</td>
