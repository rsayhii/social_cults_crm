...
@section('content')
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8 py-4">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                                <button id="add-note-btn"
                                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium flex items-center justify-center sm:justify-start order-2 sm:order-1">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div id="dashboard-view">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-8"
                            ...
                            <div class="bg-white rounded-xl shadow p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-50 rounded-lg flex items-center justify-center">
                            ...
                            <div class="bg-white rounded-xl shadow p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-green-50 rounded-lg flex items-center justify-center">
                            ...
                            <div class="bg-white rounded-xl shadow p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-50 rounded-lg flex items-center justify-center">
                            ...
                            <div class="bg-white rounded-xl shadow p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-50 rounded-lg flex items-center justify-center">
                            ...
                            <div class="bg-white rounded-xl shadow p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="w-10 h-10 sm:w-12 sm:h-12 bg-red-50 rounded-lg flex items-center justify-center">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <button id="clear-filters"
                                        class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium whitespace-nowrap">
                                        <i class="fas fa-times mr-2"></i>
                                        Clear
                                    </button>
                                    <div class="flex border border-gray-300 rounded-lg overflow-hidden">
                                        <button id="view-grid"
                                            class="p-2 bg-blue-100 text-blue-700 border-r border-gray-300">
                        ...
                        <div class="mobile-overflow-auto">
                            ...
                            <div id="empty-state" class="hidden text-center py-12">
                                <div
                                    class="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 rounded-full bg-gray-100 flex items-center justify-center">
                    ...
                    <div id="add-edit-note-view" class="hidden page-transition mobile-overflow-auto">
                        ...
                        <div class="bg-white rounded-xl shadow p-4 sm:p-6">
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-6" id="add-edit-title">Create New Note
                            </h2>
                            ...
                            <form id="note-form">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="border border-gray-300 rounded-lg overflow-hidden">
                                            <!-- Editor Toolbar -->
                                            <div
                                                class="editor-toolbar flex flex-wrap items-center border-b border-gray-300 bg-gray-50 p-2 gap-1">
                                                <button type="button" class="format-btn p-2 rounded hover:bg-gray-200"
                                                    data-command="bold" title="Bold">
                                                    <i class="fas fa-bold"></i>
                                                </button>
                                                <button type="button" class="format-btn p-2 rounded hover:bg-gray-200"
                                                    data-command="italic" title="Italic">
                                                    <i class="fas fa-italic"></i>
                                                </button>
                                                <button type="button" class="format-btn p-2 rounded hover:bg-gray-200"
                                                    data-command="underline" title="Underline">
                                            ...
                                            <div id="note-content-editor" contenteditable="true"
                                                class="w-full min-h-[150px] max-h-[300px] overflow-y-auto p-3 sm:p-4"
                                                placeholder="Start typing your note here..." required></div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="flex flex-wrap gap-1">
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="SEO">SEO</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Ads">Ads</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Website">Website</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="SMM">SMM</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Branding">Branding</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Urgent">Urgent</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Follow-up">Follow-up</button>
                                                    <button type="button"
                                                        class="tag-option text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded hover:bg-gray-200"
                                                        data-tag="Strategy">Strategy</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Related
                                                Client</label>
                                            <select id="related-client"
                                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center">
                                                    <input type="radio" id="visibility-private" name="visibility"
                                                        value="private" class="h-4 w-4 text-blue-600 focus:ring-blue-500"
                                                        checked>
                                                ...
                                                <div class="flex items-center">
                                                    <input type="radio" id="visibility-team" name="visibility" value="team"
                                                ...
                                                <div class="flex items-center">
                                                    <input type="radio" id="visibility-public" name="visibility"
                                                        value="public" class="h-4 w-4 text-blue-600 focus:ring-blue-500">
                                        ...
                                        <div id="team-selection-container" class="hidden">
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="team-seo" value="seo"
                                                        class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500">
                                                    <label for="team-seo" class="ml-2 block text-sm text-gray-700">SEO
                                                        Team</label>
                                                </div>
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="team-web" value="web"
                                                        class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500">
                                                    <label for="team-web" class="ml-2 block text-sm text-gray-700">Web Dev
                                                        Team</label>
                                                </div>
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="team-smm" value="smm"
                                                        class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500">
                                                    <label for="team-smm" class="ml-2 block text-sm text-gray-700">Social
                                                        Media Team</label>
                                                </div>
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="team-ads" value="ads"
                                                        class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500">
                                                    <label for="team-ads" class="ml-2 block text-sm text-gray-700">Ads
                                                        Team</label>
                                                </div>
                                                <div class="flex items-center">
                                                    <input type="checkbox" id="team-content" value="content"
                                                        class="h-4 w-4 text-blue-600 rounded focus:ring-blue-500">
                                                    <label for="team-content"
                                                        class="ml-2 block text-sm text-gray-700">Content Team</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8 pt-4 border-t">
                                    <button type="button" id="cancel-note"
                                        class="px-5 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium order-2 sm:order-1">
                                        Cancel
                                    </button>
                                    <button type="submit" id="submit-note"
                                        class="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium flex items-center justify-center order-1 sm:order-2">
                                        <span id="submit-text">Save Note</span>
                                        <div id="submit-spinner" class="loading-spinner ml-2 hidden"
            ...
            <div id="delete-modal"
                class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 modal-transition flex items-center justify-center p-4">
                <div class="relative mx-auto border w-full max-w-md shadow-lg rounded-xl bg-white">
                    <div class="p-5 sm:p-6 text-center">
                        ...
                        <p class="text-gray-500 mb-6" id="delete-modal-message">Are you sure you want to delete this
                            note? This
