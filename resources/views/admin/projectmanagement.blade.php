...
<head>
    ...
    <title>Digital Marketing Agency CRM | Project Management System</title>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6" id="main-content">
                ...
                <div id="dashboard-view">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0">
                        ...
                        <div class="flex space-x-3">
                            <button class="hidden px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium flex items-center">
                                <i class="fas fa-filter mr-2"></i>
                                Filter
                            </button>
                            <button id="add-project-btn" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-secondary font-medium flex items-center">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between">
                            <div class="flex flex-wrap items-center gap-3 mb-4 md:mb-0">
                                <div>
                                    ...
                                    <select id="filter-status" class="w-full md:w-auto border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                                ...
                                <div>
                                    ...
                                    <select id="filter-team" class="w-full md:w-auto border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                                ...
                                <div>
                                    ...
                                    <select id="filter-priority" class="w-full md:w-auto border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                            ...
                            <div class="flex items-center">
                                <button id="clear-filters" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
                    ...
                    <div id="no-projects-message" class="hidden text-center py-12">
                        ...
                        <button id="add-first-project-btn" class="px-5 py-2.5 bg-primary text-white rounded-lg hover:bg-secondary font-medium">
                ...
                <div id="project-details-view" class="hidden">
                    <!-- Back button -->
                    <div class="mb-6">
                        <button id="back-to-dashboard" class="flex items-center text-primary hover:text-secondary font-medium">
                ...
                <form id="project-form">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="project-name" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                            <div id="name-error" class="text-red-500 text-sm mt-1 hidden"></div>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Client Name *</label>
                            <input type="text" id="client-name" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required placeholder="Enter client name">
                        ...
                        <div>
                            ...
                            <input type="text" id="project-owner" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required placeholder="Enter project owner name">
                            <div id="owner-error" class="text-red-500 text-sm mt-1 hidden"></div>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Team *</label>
                            <select id="project-team" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Status *</label>
                            <select id="project-status" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                                <option value="pending">Pending</option>
                                <option value="in-progress">In Progress</option>
                                <option value="review">Review</option>
                                <option value="completed">Completed</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Priority *</label>
                            <select id="project-priority" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                                <option value="low">Low</option>
                                <option value="medium">Medium</option>
                                <option value="high">High</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" id="start-date" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                            <div id="start-date-error" class="text-red-500 text-sm mt-1 hidden"></div>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Deadline *</label>
                            <input type="date" id="deadline" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea rows="3" id="project-description" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Describe the project scope, deliverables, and objectives..."></textarea>
                            <div id="description-error" class="text-red-500 text-sm mt-1 hidden"></div>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Budget ($)</label>
                            <input type="number" id="project-budget" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary" >
                    ...
                    <div class="flex justify-end space-x-3 mt-8 pt-4 border-t">
                        <button type="button" id="cancel-modal" class="px-5 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
                            Cancel
                        </button>
                        <button type="submit" class="px-5 py-2.5 bg-primary text-white rounded-lg hover:bg-secondary font-medium" id="save-project-btn">
                            Save Project
                        </button>
                    </div>
                </form>
    ...
    <div id="delete-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-xl bg-white">
            <div class="text-center">
                ...
                <p class="text-gray-500 mb-6" id="delete-modal-message">Are you sure you want to delete this project? This action cannot be undone.</p>
                <div class="flex justify-center space-x-3">
                    <button id="cancel-delete" class="px-5 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
                        Cancel
                    </button>
                    <button id="confirm-delete" class="px-5 py-2.5 bg-danger text-white rounded-lg hover:bg-red-700 font-medium">
                        Delete Project
                    </button>
                </div>
            </div>
